(() => {
    ...
    home.innerHTML = `
      <section class="finish-hero">
        ...
        <div class="finish-shell finish-hero-layout">
          ...
          <div class="finish-hero-visual" aria-label="教学与学生作品">
            <figure class="finish-hero-visual-main"><img src="https://kayui-gavo.github.io/assets/tabito-classroom-v5.webp" alt="旅人教育教学空间"><figcaption><b>东京・中野</b><span>实体授课</span></figcaption></figure>
            <figure class="finish-hero-visual-art"><img src="images/student-work-illustration-city.png" alt="旅人教育美术学生作品"><figcaption><b>美术升学</b><span>学生作品</span></figcaption></figure>
      ...
      <section id="programs" class="finish-programs"><div class="finish-shell">
        ${sectionHead('升学课程','四类课程','按实际报考方式区分课程。费用、授课形式和对策范围直接列出。')}
        <div class="finish-program-editorial">
          <article class="finish-program-feature finish-program-feature--art">
            ...
            <div class="finish-program-feature-copy"><span>美术升学</span><h3>实技・作品集・志望理由・面试</h3><p>根据目标校与专业方向安排实技训练、作品制作和面试准备。</p><div class="finish-program-links"><a href="#" data-finish-page="art">查看美术课程 →</a><a href="https://xhslink.cn/o/2EDGvnprZwG" target="_blank" rel="noopener noreferrer">京都精华大学中文考试介绍 ↗</a></div></div>
          </article>
          ...
          <div class="finish-program-stack">
            ...
            <article class="finish-program-compact finish-program-compact--eju">
              <div class="finish-program-label"><small>授课形式</small><b>一对一</b><span>目标校・科目・出愿・面试</span></div>
            ...
            <article class="finish-program-compact finish-program-compact--school">
              <div class="finish-program-label finish-program-label--school"><small>目标校专项</small><b>校内考</b><span>笔试・面试・原创练习</span></div>
              <div class="finish-program-compact-copy"><h3>校内考对策</h3><p>按目标校的笔试科目、历年题型和面试要求开设专项课程或小班。</p><small class="finish-program-case">2026 对策案例：东京科学大学（理工学系）</small><a href="#" data-finish-page="eju" data-finish-target="school-exam-programs">查看校内考内容 →</a></div>
            </article>
          </div>
        </div>
      </div></section>
      ...
      <section id="results" class="finish-results"><div class="finish-shell">
        ${sectionHead('合格实绩','截至 2026 年 4 月','共记录 9 个合格校次，涉及 6 所大学。')}
        <div class="finish-results-layout finish-results-layout--balanced">
          ...
          <div class="finish-results-side">
            <article class="finish-case-note">
              <span class="finish-kicker">代表案例｜2026</span>
              <h3>东京科学大学（理工学系）</h3>
              <p>数学・物理・化学三科授课，使用原创模拟题，并在笔试后进行模拟面试。</p>
              <div class="finish-case-progress"><span><b>2</b><small>报名</small></span><i></i><span><b>2</b><small>笔试合格</small></span><i></i><span><b>2</b><small>最终合格</small></span></div>
            </article>
            <div class="finish-result-proof-grid"><figure><img src="images/success_students1.png" alt="旅人教育合格资料"><figcaption>部分合格资料</figcaption></figure><figure><img src="images/success_students.jpg" alt="旅人教育合格资料"><figcaption>合格记录</figcaption></figure></div>
          </div>
        </div>
      </div></section>

      <section id="faculty" class="finish-faculty"><div class="finish-shell">
        ${sectionHead('部分讲师介绍','授课与团队','兼任多个领域的教师会重复列出；实际担当以当期排课为准。')}
      ...
      <section id="insights" class="finish-insights"><div class="finish-shell">
        <div class="finish-insights-head"><div><span class="finish-kicker">公开内容</span><h2>升学资讯</h2></div><p>政策说明、学生采访与美术升学内容。</p></div>
        <div class="finish-insight-strip">
          ...
          <a href="https://xhslink.cn/o/2EDGvnprZwG" target="_blank" rel="noopener noreferrer"><small>美术升学・小红书</small><b>【日本美大捷径】用中文去考京都精华大学！</b><span>查看内容 ↗</span></a>
        </div>
        <div class="finish-media-links"><span>更多公开内容</span><a href="https://xhslink.cn/o/5Djzx1FPbYQ" target="_blank" rel="noopener noreferrer">共通考试教师介绍 ↗</a><a href="https://m.tech.china.com/mtz/touzi/2026/0430/230973.html" target="_blank" rel="noopener noreferrer">中华网｜2026.04.30 ↗</a><a href="https://life.china.com/2026-04/29/content_571768.html" target="_blank" rel="noopener noreferrer">中华网生活｜2026.04.29 ↗</a><a href="https://xhslink.cn/m/5QyfLyRRHK1" target="_blank" rel="noopener noreferrer">官方小红书 ↗</a></div>
      </div></section>
  ...
  function init() {
    ...
    setupSectionSpy();
    syncNav(activePage(), '');
    document.documentElement.classList.add('tabito-finishing','tabito-finishing-r15');
  }
